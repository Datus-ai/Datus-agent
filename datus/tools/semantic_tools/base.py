...
class BaseSemanticAdapter(ABC):
    ...
    def get_semantic_model(
        ...
        For backward compatibility, adapters may also return a dict with structure:
        {
    ...
    def list_semantic_models(
        ...
        For backward compatibility, adapters may also return List[str].

        Returns:
            List of SemanticModelInfo objects (or model name strings for legacy adapters)
        """
        return []
