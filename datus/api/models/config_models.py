...
class ErrorCode(str, Enum):
    ...
    SEMANTIC_MODEL_REVISION_CONFLICT = "SEMANTIC_MODEL_REVISION_CONFLICT"
    SEMANTIC_MODEL_INVALID = "SEMANTIC_MODEL_INVALID"
    SEMANTIC_MODEL_SYNC_FAILED = "SEMANTIC_MODEL_SYNC_FAILED"
