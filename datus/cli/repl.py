...
class DatusCLI:
    ...
    def __init__(self, args):
        ...
        self.commands = {
            ...
            "!sr": self.agent_commands.cmd_search_history,
            "!search_reference": self.agent_commands.cmd_search_history,
    ...
    def _cmd_help(self, args: str):
        ...
        tool_cmds = [
            ...
            ("!sr/!search_reference", "Use natural language to search for historical SQL"),
