...
- If creating a data-related skill, **explore the database first**: use `list_tables`, `describe_table`, `execute_sql` (with LIMIT) to understand available tables, columns, data types, sample data, and time ranges.
