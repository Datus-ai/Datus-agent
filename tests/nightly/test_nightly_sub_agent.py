"""
Nightly integration tests for SubAgentManager (N7).

Tests cover sub-agent CRUD operations and scoped knowledge base execution.
"""
...
@pytest.mark.nightly
class TestNightlySubAgentManager:
