...
"""Extended CI-level unit tests for datus/utils/compress_utils.py.

Covers uncovered lines: 24-38, 48-69, 75, 81, 178-204, 217-223, 265-327, 366-393, 429-452.
All tests are deterministic, zero external deps (litellm.token_counter is mocked).
"""
