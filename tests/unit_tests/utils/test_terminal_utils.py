...
class TestSuppressKeyboardInput:
    ...
    def test_noop_when_stdin_replaced(self, monkeypatch):
    ...
    def test_noop_when_stdin_is_none(self, monkeypatch):
        """Context manager is a no-op when stdin is None."""
    ...
    def test_noop_when_fileno_raises_oserror(self, monkeypatch):
...
class TestSuppressKeyboardInputEdgeCases:
    ...
    def test_exception_propagates_through_context(self, monkeypatch):
