...
"""
Extended unit tests for datus/utils/async_utils.py

CI-level: zero external dependencies, deterministic, fast.
Covers: get_or_create_event_loop, _run_in_new_loop, _run_in_thread,
        setup_windows_policy, is_event_loop_running, run_async with timeout,
        run_async with nested calls, run_async exception propagation.
"""
