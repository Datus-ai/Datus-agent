...
class TestRenderInteraction:
    ...
    def test_render_interaction_request_text(self):
        ...
        action = _make_action(
            ...
            input_data={"requests": [{"content": "Please confirm", "content_type": "text", "choices": {}}]},
        )
    ...
    def test_render_interaction_request_yaml(self):
        ...
        action = _make_action(
            ActionRole.INTERACTION,
            ActionStatus.PROCESSING,
            input_data={"requests": [{"content": "key: value", "content_type": "yaml", "choices": {}}]},
        )
        renderables = renderer.render_interaction_request(action, verbose=False)
    ...
    def test_render_interaction_request_sql(self):
        ...
        action = _make_action(
            ActionRole.INTERACTION,
            ActionStatus.PROCESSING,
            input_data={"requests": [{"content": "SELECT 1", "content_type": "sql", "choices": {}}]},
        )
        renderables = renderer.render_interaction_request(action, verbose=False)
        from rich.syntax import Syntax
    ...
    def test_render_interaction_request_with_choices_shows_content_only(self):
        ...
        action = _make_action(
            ...
            input_data={
                "requests": [
                    {"content": "Pick one: y=Yes, n=No", "content_type": "text", "choices": {"y": "Yes", "n": "No"}},
                ],
            },
        )
        renderables = renderer.render_interaction_request(action, verbose=False)
