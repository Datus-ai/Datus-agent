...
"""
Extended unit tests for datus/cli/agent_commands.py.

Covers additional uncovered lines beyond test_agent_commands.py:
- cmd_gen / cmd_fix / cmd_reason / cmd_compare / cmd_reason_stream / cmd_compare_stream
- cmd_daend
- run_node (no agent, no workflow runner)
- _extract_sql_from_streaming_actions
- _prompt_db_layers
- _print_metadata_table
- cmd_doc_search (success path, top_n invalid)
- _modify_input (SchemaLinkingInput path)
- create_node_input (TYPE_SCHEMA_LINKING, TYPE_GENERATE_SQL, TYPE_REASONING)
