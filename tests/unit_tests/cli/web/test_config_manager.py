...
def test_get_available_datasources_from_wrapped_agent_config():
...
def test_get_available_datasources_from_top_level_config():
...
def test_get_available_datasources_returns_empty_on_missing_file():
    with (
...
def test_get_available_datasources_returns_empty_on_parse_error():
    with (
