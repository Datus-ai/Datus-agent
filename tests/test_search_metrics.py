...
def test_json():
    metric = Metrics(
        ...
        metric_value= '{"name": "cancellation_rate", "owners": ["support@transformdata.io"], "type": "ratio", "type_params": {"numerator": "cancellations_usd", "denominator": "transaction_amount_usd"}}'
    )
