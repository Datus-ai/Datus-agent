...
db = lancedb.connect("/Users/lyf/.datus/data/datus_db")
...
print("$" * 100)
metadata_table = db.open_table("schema_metadata")
values_table = db.open_table("schema_value")
semantic_table = db.open_table("semantic_model")
metric_table = db.open_table("metrics")
reference_table = db.open_table("reference_sql")
