...
- **[Datus-Chat](datus_chat/chatbot.md)**：面向数据分析师的网页聊天机器人，支持多轮对话以及内置反馈机制（点赞、问题反馈、成功案例）。
...
- **数据仓库**：支持 StarRocks、Snowflake、DuckDB、SQLite、PostgreSQL 等（参见[数据库配置](configuration/databases.md)、[数据库适配器](adapters/db_adapters.md)）
