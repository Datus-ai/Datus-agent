...
- 适配器覆盖 [15 种数据库](adapters/db_adapters.zh.md)、10+ LLM 提供商与 [MCP](integration/mcp.zh.md) 服务端/客户端；[Skill](skills/introduction.zh.md) 遵循 agentskills.io 约定，支持从 marketplace 安装。
