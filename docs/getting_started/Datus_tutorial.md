...
You will see a structured 6-step workflow. This will take approximately 10 minutes to initialize through multi-turn agent calls. You can watch Datus's execution process during the wait to understand how it works.


### Step [1/6] Validate Data & Configuration
...
### Step [3/6] Initialize Semantic Model

Semantic model generation reads the success-story SQL examples and creates MetricFlow semantic model YAML before metric generation.
...
### Step [5/6] Initialize Reference SQL
