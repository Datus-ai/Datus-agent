...
!!! tip "想直接走完整数仓链路？"
    如果你要体验分层建模、ETL 生成、Airflow 调度、语义资产生成和 Superset 仪表盘发布，请继续阅读 [数据工程快速开始](./data_engineering_quickstart.md)。
...
- **[数据工程快速开始](./data_engineering_quickstart.md)** —— 使用 DAComp 构建分层数仓，并串起 Airflow 与 Superset
