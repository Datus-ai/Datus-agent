...
- **Data Warehouses**: StarRocks, Snowflake, DuckDB, SQLite, PostgreSQL, and others ([Database Configuration](configuration/databases.md), [Database Adapters](adapters/db_adapters.md))
