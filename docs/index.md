...
- Adapters cover [15 databases](adapters/db_adapters.md), 10+ LLM providers, and an [MCP](integration/mcp.md) server and client; [skills](skills/introduction.md) follow the agentskills.io convention and install from a marketplace.
