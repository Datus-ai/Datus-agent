...
"""
Save generated metric YAML file to the knowledge base.
...
def main():
    parser = argparse.ArgumentParser(description="Save metrics to knowledge base")
    parser.add_argument("--file-path", type=str, required=True, help="Metric YAML file name")
